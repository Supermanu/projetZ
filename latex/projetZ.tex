...
\includegraphics{images/bonCasBrut-eps-converted-to.pdf}
\end{figure}
\begin{figure}
\caption{Résultat typique d'une détection de 4 jets parfaits par le cluster
après passage de l'algorithme du cluster}
\includegraphics{images/bonCasNet-eps-converted-to.pdf}
\end{figure}
\begin{figure}
...
d'énergie}
\includegraphics{images/mauvaisCasBrut-eps-converted-to.pdf}
\end{figure}
\begin{figure}
\caption{Résultat  d'une détection dite à problème après passage de l'algorithme
du cluster}
\includegraphics{images/mauvaisCasNet-eps-converted-to.pdf}
\end{figure}
